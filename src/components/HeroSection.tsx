  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-64 h-64 bg-neon-pink/5 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "4s" }}
        ></div>
      </div>

      <div className="px-4 relative z-10  h-screen w-full flex items-center justify-center">
        <div className="max-w-4xl">
         <h1
  className="text-center text-3xl md:text-7xl font-bold mb-6 leading-tight animate-slide-up text-white"
  style={{ animationDelay: "0.2s" }}
>
  Transform your
  <br />
  Business with <span className="text-gradient bg-black">AI agents</span>
</h1>

          <p
            className="text-center text-lg md:text-xl text-white/80 mb-8 animate-slide-up"
            style={{ animationDelay: "0.4s" }}
          >
            Custom AI agents that automate tasks, enhance productivity, and
            drive growth.
          </p>
          <div>
            {/* <button
