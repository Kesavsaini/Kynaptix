...
/**
 * @author: @dorian_baffier
 * @description: Bento Grid (Dark Theme Only)
 * @version: 1.1.0
 * @date: 2025-06-26
 * @license: MIT
 * @website: https://kokonutui.com
...
const IconsFeature = () => {
    return (
        <div className="grid grid-cols-3 gap-4 mt-4">
            ...
            <motion.div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-gradient-to-b from-neutral-800/80 to-neutral-800 border border-neutral-700/50 group transition-all duration-300 hover:border-neutral-600">
                <div className="relative w-8 h-8 flex items-center justify-center">
                    <Plus className="w-6 h-6 text-neutral-400 transition-transform " />
                </div>
                <span className="text-xs font-medium text-center text-neutral-400 group-hover:text-neutral-200">
                    More
                </span>
...
const TimelineFeature = ({
    ...
    return (
        <div className="mt-3 relative">
            <div className="absolute top-0 bottom-0 left-[9px] w-[2px] bg-neutral-700" />
            {timeline.map((item) => (
                <motion.div
                    key={`timeline-${item.year}-${item.event
                        .toLowerCase()
                ...
                >
                    <div className="w-5 h-5 rounded-full bg-neutral-800 border-2 border-neutral-600 flex-shrink-0 z-10 mt-0.5" />
                    <div>
...
const TypingCodeFeature = ({ text }: { text: string }) => {
    ...
    return (
        <div className="mt-3 relative">
            <div className="flex items-center gap-2 mb-2">
                <div className="text-xs text-neutral-400">server.ts</div>
            </div>
            <div
                ref={terminalRef}
                className="bg-black text-neutral-100 p-3 rounded-md text-xs font-mono h-[150px] overflow-y-auto"
            >
                <pre className="whitespace-pre-wrap">
                    {displayedText}
                    <span className="animate-pulse">|</span>
    ...
    return (
        ...
        >
            <a
                ...
                className={`
                    group relative flex flex-col gap-4 h-full rounded-xl p-5
                    bg-gradient-to-b from-neutral-900/60 via-neutral-900/40 to-neutral-900/30
                    border border-neutral-800/60
                    before:absolute before:inset-0 before:rounded-xl
                    before:bg-gradient-to-b before:from-black/10 before:via-black/20 before:to-transparent
                    before:opacity-100 before:transition-opacity before:duration-500
                    after:absolute after:inset-0 after:rounded-xl after:bg-neutral-900/70 after:z-[-1]
                    backdrop-blur-[4px]
                    shadow-[0_4px_20px_rgb(0,0,0,0.2)]
                    hover:border-neutral-700/50
                    hover:shadow-[0_8px_30px_rgb(0,0,0,0.3)]
                    hover:backdrop-blur-[6px]
                    hover:bg-gradient-to-b hover:from-neutral-800/60 hover:via-neutral-800/30 hover:to-neutral-800/20
                    transition-all duration-500 ease-out ${item.className}
                `}
                tabIndex={0}
                aria-label={`${item.title} - ${item.description}`}
            >
                ...
                >
                    <div className="space-y-2 flex-1 flex flex-col">
                        <div className="flex items-center justify-between">
                            <h3 className="text-xl font-semibold tracking-tight text-neutral-100 group-hover:text-neutral-300 transition-colors duration-300">
                                {item.title}
                            </h3>
                            <div className="text-neutral-500 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
                                <ArrowUpRight className="h-5 w-5" />
                            </div>
                        </div>
                        ...
                        {item.icons && !item.feature && (
                            <div className="mt-auto pt-4 flex items-center flex-wrap gap-4 border-t border-neutral-800/70">
                                <OpenAIDark className="w-5 h-5 opacity-70 hover:opacity-100 transition-opacity" />
                                <AnthropicDark className="w-5 h-5 opacity-70 hover:opacity-100 transition-opacity" />
                                <Google className="w-5 h-5 opacity-70 hover:opacity-100 transition-opacity" />
                                <MistralAI className="w-5 h-5 opacity-70 hover:opacity-100 transition-opacity" />
                                <DeepSeek className="w-5 h-5 opacity-70 hover:opacity-100 transition-opacity" />
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <motion.div
                            variants={fadeInUp}
                            className="md:col-span-1 rounded-xl overflow-hidden bg-gradient-to-b from-neutral-900/80 to-neutral-900 border border-neutral-800/50 hover:border-neutral-600/30 hover:shadow-lg hover:shadow-neutral-900/20 transition-all duration-300"
                        >
                            <div className="p-5">
                                <div className="flex items-center justify-between mb-4">
